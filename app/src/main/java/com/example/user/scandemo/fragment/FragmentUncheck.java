...
public class FragmentUncheck extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>{
    ...
    public FragmentUncheck( String checkID) {
    ...
    protected void init() {
        ...
        checkDetailListAdapter = new CheckDetailListAdapter(1);
    ...
    private void initData() {
        checkDetailBeanList = DataSupport.where("checkID=? and status=?", checkID, "否").find(CheckDetailBean.class);
//        checkDetailListAdapter.notifyDataSetChanged();
    }
...
//                        smResult.append(data);
    ...
    private class CheckDetailListAdapter extends BaseAdapter {
        ...
        @Override
        public View getView(int position, View convertView, ViewGroup parent) { CheckListHolder holder;
            if (convertView == null) {
